<template id="processDemo">
    ...
    <div id="txStoryPanel" ><span id="closeTxStoryPos" class="fa fa-close closeTxStory"></span>
        ...
        <br/>
        <div>
            <div class="hint">*注意：为了演示的目的，这个过程的速度将被放慢</div>
        </div>
                    ...
                    setTimeout(function(){													//wait for initial panel fade in
                        ...
                        //2
                            ...
                            story2_animation(function(){
                                setTimeout(function(){
                                    show_tx_step({state: 'ordering'}, cb_orig);			//we pass callback to next step!
                                }, 5);
                        ...
                        //3
                            ...
                            story3_animation(function(){
                                setTimeout(function(){
                                    show_tx_step({state: 'committing'}, cb_orig);			//we pass callback to next step!
                                }, 5);
                            });
                        }
                        ...
                        //4
                            ...
                            setTimeout(function(){
                                ...
                                story4_animation(function(){
                                    setTimeout(function(){
                                        show_tx_step({state: 'finished'}, cb_orig);			//we pass callback to next step!
                                    }, 5);
                                });
                            }, 4000);
                        }
