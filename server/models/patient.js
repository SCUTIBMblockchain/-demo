...
var queryAllPatient = function* (name) {
  ...
  var hospitalId = name
  const allPatient = yield query.queryChaincode(hospital.peer, hospital.channelName, hospital.chaincode, [hospitalId], 'queryPatientsByHospitalId', hospital.userName, hospital.org)
  return allPatient
}
